...
const Hero = () => {
  return (
    <div className="hero">
      ...
      <p>As a dynamic development consulting firm, we specialize in empowering individuals, businesses, and communities to thrive in an increasingly interconnected world.</p>
      </div>
